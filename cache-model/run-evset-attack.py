...
# run_tests("skewed_L2_512x64-s2",     "list", 2, range( 3*1024*1024, 4*1024*1024, 32*1024), "116")
...
# run_tests("skewed_L2_256x128-s2",     "list", 2, range( 7*1024*1024, 8*1024*1024,  32*1024), "241")
...
# run_tests("skewed_L2_2048x16-s16", "list", 2, range( 5*512*1024, 15*256*1024,  32*1024), "87")
run_tests("skewed_L2_2048x16-s2-LB-INV2-GRAN", "list", 2, range( 1536*1024, 3*1024*1024,  32*1024), "70")

# run_tests("skewed_L2_256x128-s2-LB-INV2-GRAN","list", 2, range( 11010048, 11534336, 32*1024), "337")
